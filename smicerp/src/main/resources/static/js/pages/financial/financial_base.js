			...
			columns:[[
				...
				{ title: '操作',field: 'op',align:"center",width:90,formatter:function(value,rec) {
						...
						var rowInfo = rec.id + 'AaBb' + rec.billno+ 'AaBb' + rec.billtime+ 'AaBb' + rec.remark
							+ 'AaBb' + rec.accountid+ 'AaBb' + rec.accountname + 'AaBb' + rec.orgid + 'AaBb' + rec.organname
				...
				{ field: 'orgid',width:5, hidden:true},
	...
	//删除财务信息
	function deleteAccountHead(accountHeadID, thisOrgId, totalPrice){
    ...
    function editAccountHead(accountHeadTotalInfo){
        ...
        $('#OrgId').combobox('setValue', accountHeadInfo[6]);
