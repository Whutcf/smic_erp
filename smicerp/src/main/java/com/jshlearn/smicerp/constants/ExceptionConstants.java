package com.jshlearn.smicerp.constants;

/**
 * @Description
 * 系统返回码异常定义。code 格式：Type + 五位数字 例如3500000：
...
public class ExceptionConstants {
    public static final String GLOBAL_RETURN_CODE = "code";
    public static final String GLOBAL_RETURN_MESSAGE = "msg";
    public static final String GLOBAL_RETURN_DATA = "data";
     ...
     * 商品信息 type = 80
     * */
    public static final int MATERIAL_ADD_FAILED_CODE = 8000000;
    public static final String MATERIAL_ADD_FAILED_MSG = "添加商品信息失败";
    public static final int MATERIAL_DELETE_FAILED_CODE = 8000001;
    public static final String MATERIAL_DELETE_FAILED_MSG = "删除商品信息失败";
    public static final int MATERIAL_EDIT_FAILED_CODE = 8000002;
    public static final String MATERIAL_EDIT_FAILED_MSG = "修改商品信息失败";
    /**
     * 商品信息不存在
     * */
    public static final int MATERIAL_NOT_EXISTS_CODE = 8000003;
    public static final String MATERIAL_NOT_EXISTS_MSG = "商品信息不存在";
    /**
     * 商品信息不唯一
     * */
    public static final int MATERIAL_NOT_ONLY_CODE = 8000004;
    public static final String MATERIAL_NOT_ONLY_MSG = "商品信息不唯一";
    /**
     * 该商品未开启序列号功能
     * */
    public static final int MATERIAL_NOT_ENABLE_SERIAL_NUMBER_CODE = 8000005;
    public static final String MATERIAL_NOT_ENABLE_SERIAL_NUMBER_MSG = "该商品未开启序列号功能";
    /**
     * 该商品已绑定序列号数量大于等于商品现有库存
     * */
    public static final int MATERIAL_SERIAL_NUMBER_NOT_MORE_THAN_STORAGE_CODE = 8000006;
    public static final String MATERIAL_SERIAL_NUMBER_NOT_MORE_THAN_STORAGE_MSG = "该商品已绑定序列号数量大于等于商品现有库存";
    /**
     * 商品:%s库存不足
     * */
    public static final int MATERIAL_STOCK_NOT_ENOUGH_CODE = 8000007;
     ...
     * 序列号 type = 105
     * */
    public static final int SERIAL_NUMBER_ALREADY_EXISTS_CODE = 10500000;
    public static final String SERIAL_NUMBER_ALREADY_EXISTS_MSG = "序列号已存在";
    public static final int SERIAL_NUMBER_DELETE_FAILED_CODE = 10500001;
    public static final String SERIAL_NUMBER_DELETE_FAILED_MSG = "删序列号信息失败";
    /**序列号不能为为空*/
    public static final int SERIAL_NUMBER_NOT_BE_EMPTY_CODE = 10500002;
    public static final String SERIAL_NUMBER_NOT_BE_EMPTY_MSG = "序列号不能为为空";
    /**商品%s下序列号不充足，请补充后重试*/
    public static final int MATERIAL_SERIAL_NUMBER_NOT_ENOUGH_CODE = 10500003;
    public static final String MATERIAL_SERIAL_NUMBER_NOT_ENOUGH_MSG = "商品:%s下序列号不充足，请补充后重试";
    ...
    public static final String USER_NOT_EXIST_MSG = "user is not exist";

    /**
     * 用户密码错误
     */
    public static final int USER_PASSWORD_ERROR_CODE = 2;
    public static final String USER_PASSWORD_ERROR_MSG = "user password error";

    /**
     * 被加入黑名单
     */
    public static final int BLACK_USER_CODE = 3;
    public static final String BLACK_USER_MSG = "user is black";
    /**
     * 访问数据库异常
     */
    public static final int USER_ACCESS_EXCEPTION_CODE = 4;
    public static final String USER_ACCESS_EXCEPTION_MSG = "access service error";
    /**
     * 可以登录
     */
    public static final int USER_CONDITION_FIT_CODE = 5;
    public static final String USER_CONDITION_FIT_MSG = "user can login";
}
