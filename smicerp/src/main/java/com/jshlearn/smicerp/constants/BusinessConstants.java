...
public class BusinessConstants {
     ...
     * inOutItem
     */
    public static final String IN_OUT_TYPE_IN_CODE = "in";
    public static final String IN_OUT_TYPE_IN = "收入";
    public static final String IN_OUT_TYPE_OUT_CODE = "out";
    public static final String IN_OUT_TYPE_OUT = "支出";
     ...
     */
    public static final String IS_SELL = "1";
     ...
     * 用户操作行为定义
     */
    public static final Integer USER_OPERATION_SUCCESS = 0;
    public static final Integer USER_OPERATION_FAIL = 1;
    public static final String USER_OPERATION_MANAGE = "用户管理: ";
    public static final String USER_OPERATION_LOGIN = "登录系统";
